...
<main class="mt-3 p-2">
    <div class="container">
        <div class="page-title">
            <div style="font-weight: 500;" class="fs-3">User</div>
        </div>
        ...
        <div class="all-student mt-5">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    $sql = "SELECT id_user, username, nama_lengkap, level, status FROM tb_user";
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td><a href='edit_user.php?id_user=" . $row["id_user"] . "' class='btn btn-warning'><i class='bi bi-pencil-square'></i></a></td>";
                                    echo "</tr>";
                                }
                            } else {
